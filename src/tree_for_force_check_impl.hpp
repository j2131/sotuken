...
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMortonSortLocalTreeOnly(std::ostream& fout) {
...
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMortonSortGlobalTreeOnly(std::ostream& fout) {
    checkMortonSortGlobalTreeOnlyImpl(typename TSM::force_type(), fout);
}
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMortonSortGlobalTreeOnlyImpl(TagForceLong, std::ostream& fout) {
    CheckMortonSort(n_glb_tot_, tp_glb_.getPointer(), epj_sorted_.getPointer(), spj_sorted_.getPointer(), fout);
}
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMortonSortGlobalTreeOnlyImpl(TagForceShort, std::ostream& fout) {
    CheckMortonSort(n_glb_tot_, tp_glb_.getPointer(), epj_sorted_.getPointer(), fout);
}

template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMakeLocalTree(const F64 tolerance, std::ostream& fout) {
    S32 err = 0;
    F64vec center = center_;
    tc_loc_.getPointer()->checkTree(epj_sorted_.getPointer(), tc_loc_.getPointer(), center, length_ * 0.5, n_leaf_limit_, tolerance, err, fout);
    if (!err)
...
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMakeGlobalTree(const F64 tolerance, std::ostream& fout) {
    S32 err = 0;
    F64vec center = center_;
    checkMakeGlobalTreeImpl(typename TSM::force_type(), err, center, tolerance, fout);
    if (!err)
...
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMakeGlobalTreeImpl(TagForceShort, S32& err, const F64vec& center,
                                                                                            const F64 tolerance, std::ostream& fout) {
    fout << "CheckMakeGlobalTreeDummy (SCATTER, GATHER, SYMMETRY)" << std::endl;
    tc_glb_[0].checkTree(epj_sorted_.getPointer(), tc_glb_.getPointer(), center, length_ * 0.5, n_leaf_limit_, tolerance, err, fout);
}

template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMakeGlobalTreeImpl(TagForceLong, S32& err, const F64vec& center,
                                                                                            const F64 tolerance, std::ostream& fout) {
    std::cout << "CheckMakeGlobalTreeDummy (LONG, LONGCUTOFF)" << std::endl;
    tc_glb_.getPointer()->checkTreeLongGlobalTree(epj_sorted_.getPointer(), spj_sorted_.getPointer(), tp_glb_.getPointer(), tc_glb_.getPointer(),
...
checkExchangeLocalEssentialTreeForLongImpl(TagSearchLongCutoff,
    ...
    fout<<"check if the total mass of the neighbour particle by using the tree is SIMILAR (NOT have to be the same) to that evaluated
directly"<<std::endl; const S32 n_proc = Comm::getNumberOfProc(); Tepj * ep_tmp; S32 * n_ptcl; S32 * n_ptcl_disp; const S32 n_loc = this->n_loc_tot_;
        ...
        if(err_tmp == false){
            ...
            for(S32 jp0=0; jp0<pos_direct_per_proc.size(); jp0++){
                ...
                if(found){ found = false; }
                    ...
                    fout<<"pos_direct_per_proc[jp0]= "<<pos_direct_per_proc[jp0]<<"
pos_tree_per_proc[jp1_loc]="<<pos_tree_per_proc[jp1_loc]<<std::endl; err = true; break;
                }
            }
...
// LOCAL
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentLocalTree(const F64 tolerance, std::ostream& fout) {
    checkCalcMomentLocalTreeImpl(typename TSM::search_type(), tolerance, fout);
}

template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentLocalTreeImpl(TagSearchLong, const F64 tolerance,
                                                                                                 std::ostream& fout) {
    CheckCalcMomentLongLocalTree(epj_sorted_.getPointer(), n_loc_tot_, tc_loc_.getPointer(), tolerance, fout);
}

template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentLocalTreeImpl(TagSearchLongCutoff, const F64 tolerance,
                                                                                                 std::ostream& fout) {
    CheckCalcMomentOutOnly(epj_sorted_.getPointer(), n_loc_tot_, tc_loc_.getPointer(), tolerance, fout);
}

template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentLocalTreeImpl(TagSearchShortScatter, const F64 tolerance,
                                                                                                 std::ostream& fout) {
    CheckCalcMomentShortInAndOut(epj_sorted_.getPointer(), n_loc_tot_, tc_loc_.getPointer(), tolerance, fout);
}

template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentLocalTreeImpl(TagSearchShortGather, const F64 tolerance,
                                                                                                 std::ostream& fout) {
    CheckCalcMomentShortInAndOut(epi_sorted_.getPointer(), n_loc_tot_, tc_loc_.getPointer(), tolerance, fout);
}

template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentLocalTreeImpl(TagSearchShortSymmetry, const F64 tolerance,
                                                                                                 std::ostream& fout) {
    CheckCalcMomentShortInAndOut(epi_sorted_.getPointer(), n_loc_tot_, tc_loc_.getPointer(), tolerance, fout);
    CheckCalcMomentShortInAndOut(epj_sorted_.getPointer(), n_loc_tot_, tc_loc_.getPointer(), tolerance, fout);
}
...
// GLOBAL
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentGlobalTree(const F64 tolerance, std::ostream& fout) {
    checkCalcMomentGlobalTreeImpl(typename TSM::search_type(), tolerance, fout);
}

template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentGlobalTreeImpl(TagSearchLong, const F64 tolerance,
                                                                                                  std::ostream& fout) {
    CheckCalcMomentLongGlobalTree(epj_sorted_.getPointer(), spj_sorted_.getPointer(), n_glb_tot_, tc_glb_.getPointer(), tp_glb_.getPointer(),
                                  tolerance, fout);
}

template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentGlobalTreeImpl(TagSearchLongCutoff, const F64 tolerance,
                                                                                                  std::ostream& fout) {
    CheckCalcMomentLongGlobalTree(epj_sorted_.getPointer(), spj_sorted_.getPointer(), n_glb_tot_, tc_glb_.getPointer(), tp_glb_.getPointer(),
                                  tolerance, fout);
}
...
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentGlobalTreeImpl(TagSearchShortScatter, const F64 tolerance,
                                                                                                  std::ostream& fout) {
    CheckCalcMomentShortInAndOut(epj_sorted_.getPointer(), n_glb_tot_, tc_glb_.getPointer(), tolerance, fout);
}

template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentGlobalTreeImpl(TagSearchShortGather, const F64 tolerance,
                                                                                                  std::ostream& fout) {
    CheckCalcMomentShortInOnly(epj_sorted_.getPointer(), n_glb_tot_, tc_glb_.getPointer(), tolerance, fout);
}

template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkCalcMomentGlobalTreeImpl(TagSearchShortSymmetry, const F64 tolerance,
                                                                                                  std::ostream& fout) {
    CheckCalcMomentShortInAndOut(epj_sorted_.getPointer(), n_glb_tot_, tc_glb_.getPointer(), tolerance, fout);
}
...
// MAKE IPGROUP //
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMakeInteractionListImpl(TagSearchLong, const DomainInfo& dinfo,
...
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMakeInteractionListImpl(TagSearchLongCutoff, const DomainInfo& dinfo,
                                                                                                 const S32 adr_ipg, const S32 ith,
                                                                                                 const F64 tolerance, std::ostream& fout) {
...
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMakeInteractionListImpl(TagSearchShortScatter, const DomainInfo& dinfo,
                                                                                                 const S32 adr_ipg, const S32 ith,
                                                                                                 const F64 tolerance, std::ostream& fout) {
    // for SCATTER
    bool err = false;
...
#else
                    return (left.x == right.x) ? ((left.y == right.y) ? ((left.z == right.z) ? true : left.z < right.z) : left.y < right.y)
                                               : left.x < right.x;
#endif
                }
            };
...
#else
// not checked yet
            auto comp_func = [](const auto& lhs, const auto& rhs) -> bool {
#if defined(PARTICLE_SIMULATOR_TWO_DIMENSION)
                return lhs.x == rhs.x ? (lhs.y == rhs.y ? true : lhs.y < rhs.y) : lhs.x < rhs.x;
#else
                return lhs.x == rhs.x ? (lhs.y == rhs.y ? (lhs.z == rhs.z ? true : lhs.z < rhs.z) : lhs.y < rhs.y) : lhs.x < rhs.x;
#endif
            };
            std::sort(pos_tree.getPointer(), pos_tree.getPointer(pos_tree.size() + 1), comp_func);
            std::sort(pos_direct.getPointer(), pos_direct.getPointer(pos_direct.size() + 1), comp_func);
#endif
...
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMakeInteractionListImpl(TagSearchShortGather, const DomainInfo& dinfo,
                                                                                                 const S32 adr_ipg, const S32 ith,
                                                                                                 const F64 tolerance, std::ostream& fout) {
...
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMakeInteractionListImpl(TagSearchShortSymmetry, const DomainInfo& dinfo,
                                                                                                 const S32 adr_ipg, const S32 ith,
                                                                                                 const F64 tolerance, std::ostream& fout) {
    std::cout << "under construction" << std::endl;
    // for SYMMETRY
...
template <class TSM, class Tforce, class Tepi, class Tepj, class Tmomloc, class Tmomglb, class Tspj>
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkMakeIPGroup(const F64 tolerance, std::ostream& fout) {
    ...
    if (err_wrongadr || err_overflow || err_outofbox) {
        fout << "checkMakeIPGroup: FAIL err_overflow=" << err_overflow << "err_wrongadr=" << err_wrongadr << "err_outofbox=" << err_outofbox
             << std::endl;
    } else {
...
void TreeForForce<TSM, Tforce, Tepi, Tepj, Tmomloc, Tmomglb, Tspj>::checkForce(Tfunc_ep_ep pfunc_ep_ep, Tfunc_compare func_compare,
